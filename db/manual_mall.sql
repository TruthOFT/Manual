...
create table artisan_profile (
    id bigint unsigned not null comment '匠人档案id',
    userId bigint unsigned not null comment '关联用户id',
    artisanName varchar(64) not null comment '匠人姓名',
    ...
    craftCategory varchar(64) null comment '擅长工艺',
    originPlace varchar(128) null comment '所在地区',
    ...
    shelfStatus tinyint not null default 0 comment '店铺状态：0-停用 1-启用',
    createTime datetime null default current_timestamp,
    updateTime datetime null default current_timestamp on update current_timestamp,
    isDelete tinyint(1) null default 0,
    primary key (id),
...
) engine = innodb default charset = utf8mb4 collate = utf8mb4_unicode_ci comment = '匠人档案表';

create table category (
    id bigint unsigned not null comment '分类id',
    parentId bigint unsigned null comment '父级分类id',
...
create table product (
    ...
    artisanId bigint unsigned not null comment '匠人档案id',
...
create table product_image (
    ...
    imageType varchar(32) not null default 'detail' comment '图片类型：cover/detail',
    sortOrder int not null default 0 comment '排序值',
    createTime datetime null default current_timestamp,
    updateTime datetime null default current_timestamp on update current_timestamp,
    isDelete tinyint(1) null default 0,
...
create table user_address (
    ...
    receiverName varchar(64) not null comment '收货人',
    receiverPhone varchar(20) not null comment '收货手机号',
...
create table order_logistics (
    ...
    senderName varchar(64) null comment '寄件人',
    senderPhone varchar(20) null comment '寄件电话',
    receiverName varchar(64) null comment '收件人',
    receiverPhone varchar(20) null comment '收件电话',
